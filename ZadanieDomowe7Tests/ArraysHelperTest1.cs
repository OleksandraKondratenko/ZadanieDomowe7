...
namespace ZadanieDomowe7Tests
{
    public class ArraysHelperTest
    {
        ...
        {
            int result = ArraysHelper1.FindMinElementOfArray(array);
        ...
        {
            int result = ArraysHelper1.FindMaxElementOfArray(array);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            int result = ArraysHelper1.FindIndexMinElementOfArray(array);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            int result = ArraysHelper1.FindIndexMaxElementOfArray(array);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            int result = ArraysHelper1.SumOfArrayEllementOddIndex(array);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            int[] result = ArraysHelper1.ReverseArray(array);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            int result = ArraysHelper1.CountOddIndexOfArray(array);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            int[] result = ArraysHelper1.ReplaceFirstSecondPartOfNumber(array);
        ...
        {
            int[] result = ArraysHelper1.SelectSort(array);
            CollectionAssert.AreEqual(expected, result);
        }
        ...
        {
            int[] result = ArraysHelper1.InsertSort(array);
            CollectionAssert.AreEqual(expected,result);
        }
    }
}
