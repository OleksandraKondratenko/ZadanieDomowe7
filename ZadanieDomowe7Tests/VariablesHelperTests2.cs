...
namespace ZadanieDomowe7Tests
{
    public class VariablesHelperTests2
    {
        ...
        {
            Assert.Throws<DivideByZeroException>(() => VariablesHelper2.GetEquationValue(num1, num2));
        }
        ...
        {
            VariablesHelper2.Swap(ref num1, ref num2);
        ...
        {
            (int, int) result = VariablesHelper2.GetDivisionAndDivisionReminder(num1, num2);
        ...
        {
            Assert.Throws<DivideByZeroException>(() => VariablesHelper2.GetDivisionAndDivisionReminder(num1,num2));
        }

        [TestCase(2,6,20,7)]
        public void GetLinearEquationValue_WhenTestIsPassed_ShouldBeCalculate(int num1, int num2, int num3, double expected)
        {
            double result = VariablesHelper2.GetLinearEquationValue(num1, num2, num3);
            Assert.AreEqual(expected, result);
        }
        ...
        {
            Assert.Throws<DivideByZeroException>(() => VariablesHelper2.GetLinearEquationValue(num1, num2, num3));
        }
        ...
        {
            (double, double) result = VariablesHelper2.GetEquationOfTheLine(x1, y1, x2, y2);
            Assert.AreEqual(expected, result);
        }
