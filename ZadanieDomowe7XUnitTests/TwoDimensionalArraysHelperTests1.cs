...
namespace ZadanieDomowe7XUnitTests
{
    public class TwoDimensionalArraysHelperTests
    {
        ...
        {
            int result =TwoDimensionalArraysHelper1.FindMinElementOfArray(array);
        ...
        {
            int result = TwoDimensionalArraysHelper1.FindMaxElementOfArray(array);
            Assert.Equal(expected, result);
        }
        ...
        {
            (int,int) result = TwoDimensionalArraysHelper1.FindIndexMinElementOfArray(array);
            Assert.Equal(expected, result);
        }
        ...
        {
            (int,int) result = TwoDimensionalArraysHelper1.FindIndexMaxElementOfArray(array);
            Assert.Equal(expected, result);
        }
        ...
        {
            int result = TwoDimensionalArraysHelper1.CompareWithNeithbours(array);
            Assert.Equal(expected, result);
        }
        ...
        {
            int[,] result = TwoDimensionalArraysHelper1.MirrorViewOfArray(array);
            Assert.Equal(expected, result);
        }
